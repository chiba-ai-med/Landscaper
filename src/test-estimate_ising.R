...
# Freq.tsv
#######################################
Freq <- read.table("output/Freq.tsv", header=FALSE)
# Size: States
...
# P_emp.tsv
#######################################
P_emp <- as.matrix(read.table("output/P_emp.tsv", header=FALSE))
# Size: States
...
# P_est.tsv
#######################################
P_est <- as.matrix(read.table("output/P_est.tsv", header=FALSE))
# Size: States
...
# h.tsv
#######################################
h <- as.matrix(read.table("output/h.tsv", header=FALSE))
# Size: Variables
...
# J.tsv
#######################################
J <- as.matrix(read.table("output/J.tsv", header=FALSE))
...
# E.tsv
#######################################
E <- as.matrix(read.table("output/E.tsv", header=FALSE))
# Size: States
