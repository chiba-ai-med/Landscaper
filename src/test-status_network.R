...
# StatusNetwork.tsv
#######################################
A <- as.matrix(read.table("output/StatusNetwork.tsv", header=FALSE))
# Size: States × States
...
# SubGraph.tsv
#######################################
G_sub <- read.table("output/SubGraph.tsv", header=FALSE)
# Size: States
...
# Basin.tsv
#######################################
Basin <- read.table("output/Basin.tsv", header=FALSE)
# Size: 1 to States
...
# Coordinate.tsv
#######################################
Coordinate <- read.table("output/Coordinate.tsv", header=FALSE)
# Size: States × 2
...
E <- unlist(read.table("output/E.tsv", header=FALSE))
Basin_idx <- unlist(read.table("output/Basin.tsv", header=FALSE))
