...
# Freq.tsv
#######################################
Freq <- read.table("output_cont/Freq.tsv", header=FALSE)
# Size: States
...
# P_emp.tsv
#######################################
P_emp <- as.matrix(read.table("output_cont/P_emp.tsv", header=FALSE))
# Size: States
...
# P_est.tsv
#######################################
P_est <- as.matrix(read.table("output_cont/P_est.tsv", header=FALSE))
# Size: States
...
# h.tsv
#######################################
h <- as.matrix(read.table("output_cont/h.tsv", header=FALSE))
# Size: Variables
...
# J.tsv
#######################################
J <- as.matrix(read.table("output_cont/J.tsv", header=FALSE))
...
# E.tsv
#######################################
E <- as.matrix(read.table("output_cont/E.tsv", header=FALSE))
# Size: States
